...
| Release validators (D)  | Captain 2026-09-02: teach, don't exclude. `OPENCLAW_RELEASE_TAG_PATTERN` accepts `vYYYY.M.P-omnisclaw.N`. Workspace packages at the upstream base (`2026.8.1`) match fork-stamped root (`2026.8.1-omnisclaw.0`); a different base or a mismatched fork stamp still fails. Scripts stay in the suite.                      |
