...
async function resolveXaiAudioApiKey(
  ...
  throw new Error(
    "xAI credentials missing for TTS. Sign in with `omnisclaw onboard --auth-choice xai-oauth`, or run `omnisclaw onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
