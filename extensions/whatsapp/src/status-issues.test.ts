    ...
    expect(issues).toEqual([
      {
        ...
        fix: "Run: omnisclaw channels login (scan QR on the gateway host).",
      },
    ]);
  });
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        ...
        fix: "Run: omnisclaw doctor (or restart the gateway). If it persists, relink via channels login and check logs.",
      },
    },
    ...
    expect(issues).toEqual([
      {
        ...
        fix: "Watch: omnisclaw logs --follow and run omnisclaw channels status --probe if disconnects continue. If it keeps flapping, restart the gateway or relink via channels login.",
      },
    ]);
  });
