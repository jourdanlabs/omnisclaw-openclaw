/** Builds the interactive `omnisclaw secrets configure` target list and apply plan. */
...
/** Credential target shown by `omnisclaw secrets configure` before a SecretRef is selected. */
