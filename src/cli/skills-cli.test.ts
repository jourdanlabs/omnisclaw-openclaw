...
describe("skills-cli", () => {
  ...
  describe("ClawHub command hints", () => {
    it.each([
      {
        ...
        profile: "work",
        container: "",
        prefix: "omnisclaw --profile work",
      },
      {
        name: "managed container",
        profile: "",
        container: "demo",
        prefix: "omnisclaw --container demo",
      },
      {
    ...
    it("keeps profile and container guidance out of machine-readable skill output", () => {
      ...
      for (const output of outputs) {
        ...
        expect(output).not.toContain("omnisclaw --profile");
        expect(output).not.toContain("omnisclaw --container");
      }
    });
  });
  ...
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("omnisclaw skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("omnisclaw skills install");
    });
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("omnisclaw skills update");
    });
