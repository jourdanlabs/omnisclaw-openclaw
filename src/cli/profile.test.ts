...
describe("formatCliCommand", () => {
  const displayed = (command: string) =>
    command.replace(
      /^(?:(pnpm|npm|bunx|npx)\s+)?openclaw\b/,
      (_match, runner?: string) => `${runner ? `${runner} ` : ""}omnisclaw`,
    );

  it.each([
    {
      name: "no profile is set",
      cmd: "omnisclaw doctor --fix",
      env: {},
      expected: "omnisclaw doctor --fix",
    },
    {
  ...
  it("inserts --container when a container hint is set", () => {
    ...
    ).toBe("omnisclaw --container demo gateway status --deep");
  });
  ...
  it("ignores unsafe container hints", () => {
    ...
    ).toBe("omnisclaw gateway status --deep");
  });
  ...
  it("preserves both --container and --profile hints", () => {
    ...
    ).toBe("omnisclaw --container demo doctor");
  });

  it.each([
    "omnisclaw update",
    "pnpm omnisclaw update --channel beta",
    "npm omnisclaw update",
    "bunx omnisclaw update",
    "npx omnisclaw update",
    "omnisclaw --profile work update",
    "omnisclaw --profile=work update",
    "omnisclaw --log-level debug update",
    "omnisclaw --log-level=debug update",
    "omnisclaw --dev update",
    "omnisclaw --no-color update",
    "omnisclaw --no-color --profile work --log-level=debug update",
    "omnisclaw --profile update update",
    "pnpm omnisclaw --profile work update --channel beta",
  ...
  it.each([
    ...
    ).toBe(`${displayed(prefix)} --container demo ${command}`);
  });
});
