    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "omnisclaw node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["omnisclaw node status", "Check node host service status."],
          ["omnisclaw node install", "Install the node host service."],
          ["omnisclaw node start", "Start the installed node host service."],
          ["omnisclaw node restart", "Restart the installed node host service."],
