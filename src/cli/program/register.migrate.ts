    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["omnisclaw migrate list", "Show available migration providers."],
          ["omnisclaw migrate hermes", "Preview Hermes migration, then prompt before applying."],
          ["omnisclaw migrate hermes --dry-run", "Preview Hermes migration only."],
          [
            "omnisclaw migrate apply hermes --yes",
            "Apply Hermes migration non-interactively after writing a verified backup.",
          ],
          [
            "omnisclaw migrate hermes --no-auth-credentials",
