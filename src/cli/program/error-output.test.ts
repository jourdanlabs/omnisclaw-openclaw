...
describe("formatCliParseErrorOutput", () => {
  it.each([
    ...
    },
    {
      ...
      message: 'OMNIS CLAW does not recognize option "--unknown".',
  ...
  it("uses the same structured root diagnostic as the human renderer", () => {
    ...
    expect(error.message).toBe('OMNIS CLAW does not know the command "pairng".');
    expect(error.humanOutput).toBe(
      'OMNIS CLAW does not know the command "pairng".\nDid you mean this?\n  omnisclaw pairing\nTry: omnisclaw --help\nPlugin command? omnisclaw plugins list\nDocs: https://docs.openclaw.ai/cli\n',
    );
  });
  ...
  it("strips Commander framing from structured nested diagnostics", () => {
    ...
    expect(error.message).toBe('OMNIS CLAW sessions has no command "lst".');
  ...
  it("explains unknown commands with root help and plugin hints", () => {
    ...
    expect(output).toBe(
      'OMNIS CLAW does not know the command "wat".\nTry: omnisclaw --help\nPlugin command? omnisclaw plugins list\nDocs: https://docs.openclaw.ai/cli\n',
    );
  });
  ...
  it("explains unknown subcommands within the active command tree", () => {
    ...
    expect(output).toBe(
      'OMNIS CLAW webhooks has no command "list".\nTry: omnisclaw webhooks --help\nDocs: https://docs.openclaw.ai/cli\n',
    );
  });
  ...
  it("suggests sibling subcommands within the active command tree", () => {
    ...
    expect(output).toBe(
      'OMNIS CLAW webhooks has no command "gmial".\nDid you mean this?\n  omnisclaw webhooks gmail\nTry: omnisclaw webhooks --help\nDocs: https://docs.openclaw.ai/cli\n',
    );
  });
  ...
  it("suggests a live child command when later arguments follow the typo", async () => {
    ...
    expect(error.code).toBe("commander.unknownCommand");
    expect(output).toBe(
      'OMNIS CLAW config has no command "gett".\nDid you mean this?\n  omnisclaw config get\nTry: omnisclaw config --help\nDocs: https://docs.openclaw.ai/cli\n',
    );
  });
  ...
  it("suggests close known commands for unknown commands", () => {
    ...
    expect(output).toBe(
      'OMNIS CLAW does not know the command "upate".\nDid you mean this?\n  omnisclaw update\nTry: omnisclaw --help\nPlugin command? omnisclaw plugins list\nDocs: https://docs.openclaw.ai/cli\n',
    );
  });
  ...
  it("points unknown options at the active command help", () => {
    ...
    expect(output).toBe(
      'OMNIS CLAW does not recognize option "--wat".\nTry: omnisclaw channels status --help\n',
    );
  });
  ...
  it("points missing required arguments at command help", () => {
    ...
    expect(output).toBe(
      'Missing required argument "name".\nTry: omnisclaw plugins install --help\n',
    );
  });
  ...
  it("prefers the parsed Commander path over option-like argv values", () => {
    ...
    expect(output).toBe(
      'OMNIS CLAW does not recognize option "--wat".\nTry: omnisclaw plugins list --help\n',
    );
  });
});
