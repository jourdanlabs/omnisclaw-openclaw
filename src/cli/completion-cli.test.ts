...
`,
  ...
  it("generates PowerShell command paths without the executable prefix", () => {
    ...
    expect(script).not.toContain("if ($commandPath -eq 'omnisclaw gateway') {");
  ...
  itWithPowerShell.each([
    ["a long shell flag", "omnisclaw completion --shell f"],
    ["a short shell flag", "omnisclaw completion -s f"],
  ...
  itWithPowerShell.each([
    {
      ...
      commandLine: "omnisclaw --mode --j",
      expected: ["--json"],
    },
    {
      name: "an inline optional value",
      commandLine: "omnisclaw --mode=a",
      expected: ["--mode=auto"],
    },
    {
      name: "a hyphen-prefixed optional choice",
      commandLine: "omnisclaw --mode -l",
      expected: ["-legacy"],
    },
  ...
  itWithPowerShell.each([
    {
      ...
      commandLine: "omnisclaw --value al",
      expected: ["alpha"],
    },
    {
      name: "a literal asterisk",
      commandLine: "omnisclaw --value a*",
      expected: ["'a*literal'"],
    },
    {
  ...
  itWithPowerShell.each([
    ...
    expect(await powerShellCompletion.complete(program, `omnisclaw --value ${prefix}`)).toEqual([
      safeValue,
    ]);
    expect(await powerShellCompletion.complete(program, `omnisclaw --value=${prefix}`)).toEqual([
      `--value=${safeValue}`,
  ...
  itWithPowerShell.each([
    ["a long flag", "omnisclaw gateway --token secret st"],
    ["a short flag", "omnisclaw gateway -t secret st"],
    ["an inline long value", "omnisclaw gateway --token=secret st"],
    ["an inline short value", "omnisclaw gateway -t=secret st"],
    ["a preceding boolean flag", "omnisclaw gateway --force --token secret st"],
  ...
  itWithFish.each([
    ["a separate long root option", "omnisclaw --profile work g"],
    ["an inline long root option", "omnisclaw --profile=work g"],
    ["a separate short root option", "omnisclaw -p work g"],
    ["an inline short root option", "omnisclaw -p=work g"],
    ["an attached short root option", "omnisclaw -pwork g"],
    ["a separate log-level root option", "omnisclaw --log-level debug g"],
    ["an inline log-level root option", "omnisclaw --log-level=debug g"],
    ["a separate container root option", "omnisclaw --container local g"],
    ["an inline container root option", "omnisclaw --container=local g"],
    ["repeated root options", "omnisclaw --profile first --profile second g"],
    [
      "mixed value-taking root options",
      "omnisclaw --profile work --log-level debug --container local g",
    ],
    ["a preceding boolean root option", "omnisclaw -v --profile work g"],
    ["a root option value named like a command", "omnisclaw --profile gateway g"],
  ...
  itWithFish.each([
    ["a separate long root option", "omnisclaw --profile work --p"],
    ["an inline long root option", "omnisclaw --profile=work --p"],
    ["a separate short root option", "omnisclaw -p work --p"],
    ["repeated root options", "omnisclaw --profile first --profile second --p"],
  ...
  itWithFish.each([
    ["the exact nested command", "omnisclaw gateway status -"],
    ["a separate long option value", "omnisclaw gateway --token secret status -"],
    ["a separate short option value", "omnisclaw gateway -t secret status -"],
    ["an inline long option value", "omnisclaw gateway --token=secret status -"],
    ["an inline short option value", "omnisclaw gateway -t=secret status -"],
    ["a parent boolean option", "omnisclaw gateway --force status -"],
  ...
  itWithFish.each([
    ["a positional argument", "omnisclaw gateway status query -"],
    ["multiple positional arguments", "omnisclaw gateway status first second -"],
    ["a positional argument named like a sibling", "omnisclaw gateway status restart -"],
    ["a long option and positional argument", "omnisclaw gateway --token secret status query -"],
    ["an inline option and positional argument", "omnisclaw gateway --token=secret status query -"],
  ...
  itWithFish("preserves documented short and long completion flags in real Fish", () => {
    expect(
      runGeneratedFishCompletion(createDocumentedCompletionProgram(), "omnisclaw completion -"),
    ).toEqual(
  ...
  itWithFish.each([
    ["a separated long optional value", "omnisclaw --color a", "always"],
    ["a separated short optional value", "omnisclaw -c n", "never"],
  ...
  itWithPowerShell.each([
    ["a separate option value", "omnisclaw completion --shell f", "fish"],
    ["an attached option value", "omnisclaw completion --shell=f", "--shell=fish"],
    ["an attached short option value", "omnisclaw completion -sf", "-sfish"],
    ["a short-option cluster value", "omnisclaw completion -ysf", "-ysfish"],
    ["a separated short-option cluster value", "omnisclaw completion -ys f", "fish"],
  ...
  itWithPowerShell("completes an empty attached short-option cluster value", async () => {
    expect(
      await powerShellCompletion.complete(
        createDocumentedCompletionProgram(),
        "omnisclaw completion -ys",
      ),
    ).toEqual(["-yszsh", "-ysbash", "-yspowershell", "-ysfish"]);
  });

  itWithPowerShell.each([
    ["a spaced choice", "omnisclaw --theme l", "'light blue'"],
    ["an attached spaced choice", "omnisclaw --theme=l", "--theme='light blue'"],
    ["an apostrophe", "omnisclaw --theme Bob", "'Bob''s green'"],
  ...
  itWithPowerShell(
    ...
    async () => {
      ...
      expect(await powerShellCompletion.complete(program, "omnisclaw --color a")).toEqual([
        "always",
      ]);
      expect(await powerShellCompletion.complete(program, "omnisclaw --color --v")).toEqual([
        "--verbose",
      ]);
    },
  );
