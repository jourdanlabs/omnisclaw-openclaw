...
function findGatewayPidsOnPortWithProtectedPidSync(
  ...
  if (process.platform === "win32") {
    ...
    // command-line verification to find only omnisclaw gateway processes.
 ...
 * Returns only PIDs that belong to omnisclaw gateway processes (not the current process).
 */
