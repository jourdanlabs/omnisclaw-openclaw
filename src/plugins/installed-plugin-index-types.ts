...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by OpenClaw from plugin manifests, install records, and config policy. Use `omnisclaw plugins registry --refresh`, `omnisclaw plugins install/update/uninstall`, or `omnisclaw plugins enable/disable` instead.";
