  ...
  it.each([
    {
      ...
      message: 'Agent "агент✨" not found. Run omnisclaw agents list to see configured agents.',
    },
    {
      name: "bindings with an unknown agent",
      command: "bindings",
      options: { agent: "ghost", json: true },
      message: 'Agent "ghost" not found. Run omnisclaw agents list to see configured agents.',
    },
    {
    ...
    },
    {
      ...
      message: 'Agent "   " not found. Run omnisclaw agents list to see configured agents.',
    },
    {
    ...
    },
    {
      ...
      message:
        'Unknown channel "definitely-not-a-channel". Run `omnisclaw channels list --all` to see configured and installable channels.',
