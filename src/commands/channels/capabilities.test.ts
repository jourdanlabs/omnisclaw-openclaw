  ...
  it.each([
    {
      ...
      message:
        "--account requires a specific --channel. Run omnisclaw channels list to choose one.",
    ...
    },
    {
      ...
      message: "--target requires a specific --channel. Run omnisclaw channels list to choose one.",
      discoversChannels: false,
    },
    {
