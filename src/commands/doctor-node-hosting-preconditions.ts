...
export function collectNodeHostingPreconditionFindings(
  ...
  if (lacksNodeOnboardingPlugin(cfg)) {
    findings.push({
      ...
      severity: "warning",
      message:
        "The device-pair plugin is not enabled; node onboarding join codes and omnisclaw connect are unavailable.",
