...
export const forcedUnitFastTestFiles = [
  ...
  "src/omnisclaw/terminus/action-gate.test.ts",
  "src/omnisclaw/terminus/action-gate.runtime.test.ts",
  "src/omnisclaw/terminus/spawn-exemptions.test.ts",
